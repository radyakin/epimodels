...
{synopt :{opt days(#)}}Optional number of days for advancing the
 simulations, value of 30 is applied if this parameter is omitted. {p_end}
...
{synopt :{opt percent}} indicates the model results should be reported as percentages.{p_end}
