...
infected individuals in a closed population over time. The model is commonly 
used for modeling the development of directly transmitted infectious disease 
(spread through contacts between individuals). See Kermack-McKendrick (1927) 
...
theory of epidemics, part i. Proceedings of the Royal Society of Edinburgh. 
