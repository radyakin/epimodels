...
{synopt :{opt gamma(#)}}The model parameter controlling how often 
an infected individual recovers{p_end}
...
modeling the development of directly transmitted infectious disease (spread 
through contacts between individuals). The model differs from SIR by 
